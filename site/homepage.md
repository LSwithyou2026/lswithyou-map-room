...
<main class="knowledge-home">
  ...
  <nav class="knowledge-directory" aria-label="海图室目录">
    ...
    <a class="archive-folder folder-00" href="./00-登舱指南🛋️/">
      ...
      <span class="directory-name"><strong>登舱指南 <b aria-hidden="true">›</b></strong><small>第一次来，从这里开始</small></span>
    </a>
    <a class="archive-folder folder-01" href="./01-船员档案⚓️/">
      <span class="directory-number">NO. 01</span>
      <span class="folder-stamp">CREW<br>FILE</span>
      <span class="folder-watermark" aria-hidden="true"></span>
      <span class="directory-name"><strong>船员档案 <b aria-hidden="true">›</b></strong><small>船员名册与甲板联谊</small></span>
    </a>
    <a class="archive-folder folder-02" href="./02-解惑灯塔💡/">
